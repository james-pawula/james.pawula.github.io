...
html_text = <<-HTML
<ul>
  <li>href="https://www.freecodecamp.org/news/crack-passwords-using-john -the-ripper-pentesting-tutorial/">How to Crack Passwords using John the Ripper – Pentesting Tutorial</li>
  <li>Item 2</li>
  <li>Item 3</li>
</ul>
HTML
